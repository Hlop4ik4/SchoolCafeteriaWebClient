            ...
            <v-dialog max-width="720">
                ...
                <template v-slot:default="{ isActive }">
                    <v-card title="Новая сущность">
                        ...
                        <v-text-field label="Номер рецепта" type="number" v-model="state.techMapCurrentItem.recipeNumber"></v-text-field>
                        ...
                        <v-dialog max-width="720">
                            ...
                            <template v-slot:default="{ isActive }">
                                <v-card title="Новая сущность">
                                    ...
                                    <v-text-field label="Номер рецепта" type="number" v-model="state.techMapUpdateItem.recipeNumber"></v-text-field>
